...
\033[1;33m║\033[1;30m╚═╝░░╚═╝░╚═════╝░╚═╝░░╚══╝░╚═════╝░╚═════╝░╚══════╝░░░╚═╝░░░░░░░░░░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝\033[1;33m
        ...
        \x1b[38;5;207m ZALO : \x1b[38;5;46m0332369907
        \x1b[38;5;207m ADMIN : \x1b[38;5;46mNGUYỄN BÙI VIỆT HƯNG
        \x1b[38;5;207m FACEBOOK : \x1b[38;5;46mhttp://facebook.com/trumkimsa3
        \x1b[38;5;207m MUA KEY VIP LIÊN HỆ ZALO: 0332369907 (1K/1day) \x1b[38;5;46m
   \x1b[38;5;207m╚══\x1b[38;5;226m══\x1b[38;5;99m══\x1b[38;5;46m══\x1b[38;5;51m══\x1b[38;5;208m══\x1b[38;5;51m══\x1b[38;5;46m══\x1b[38;5;99m══\x1b[38;5;207m══\x1b[38;5;51m══\x1b[38;5;226m══\x1b[38;5;99m══\x1b[38;5;46m══\x1b[38;5;51m══\x1b[38;5;208m══\x1b[38;5;51m══\x1b[38;5;46m══\x1b[38;5;99m══\x1b[38;5;207m══\x1b[38;5;51m══\x1b[38;5;226m══\x1b[38;5;99m══\x1b[38;5;46m══\x1b[38;5;51m══\x1b[38;5;208m══\x1b[38;5;51m══\x1b[38;5;46m══\x1b[38;5;99m══\x1b[38;5;207m══\x1b[38;5;51m══\x1b[38;5;46m═╝
   \033[1;35mTOOL TDS PRO5
"""
######[DEF AUTO]########
def echo(text):
...
def idelay(delaymin, delaymax):
	...
	for demtg in range(int(delay), -1, -1):
		print(trang+"["+xanh+"NBVH-TOOL"+trang+"] ["+xanh+"L         "+trang+"] ["+xanh+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+cam+"NBVH-TOOL"+trang+"] ["+cam+"L"+xanh+"O        "+trang+"] ["+cam+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+blue+"NBVH-TOOL"+trang+"] ["+blue+"L"+xanh+"O"+cam+"A       "+trang+"] ["+blue+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+lam+"NBVH-TOOL"+trang+"] ["+lam+"L"+xanh+"O"+cam+"A"+blue+"D      "+trang+"] ["+lam+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+tim+"NBVH-TOOL"+trang+"] ["+tim+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I     "+trang+"] ["+tim+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+xnhac+"NBVH-TOOL"+trang+"] ["+xnhac+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N    "+trang+"] ["+xnhac+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+den+"NBVH-TOOL"+trang+"] ["+den+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G   "+trang+"] ["+den+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+do+"NBVH-TOOL"+trang+"] ["+do+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.  "+trang+"] ["+do+str(demtg)+trang+"]",end="\r")
		sleep(0.2)
		print(trang+"["+vang+"NBVH-TOOL"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.. "+trang+"] ["+vang+str(demtg)+trang+"]",end="\r")
		sleep(0.3)
		print(trang+"["+vang+"NBVH-TOOL"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G..."+trang+"] ["+vang+str(demtg)+trang+"]",end="\r")
